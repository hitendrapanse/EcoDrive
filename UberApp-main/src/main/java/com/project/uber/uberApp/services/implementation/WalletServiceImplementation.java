...
public class WalletServiceImplementation implements WalletService {
    ...
    public Wallet findWalletById(long walletId) {
        return walletRepository.findById(walletId).orElseThrow(()->new ResourceNotFoundException(
                "Wallet not found withId "+walletId
        ));
    }
    ...
    public Wallet findByUser(User user) {
        return walletRepository.findByUser(user).orElseThrow(()->new ResourceNotFoundException(
